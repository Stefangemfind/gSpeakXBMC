...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gspeakxbmc: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/gspeakxbmc ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/21457980/config.o: /root/NetBeansProjects/gSpeakXBMC/config.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/21457980
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/21457980/config.o /root/NetBeansProjects/gSpeakXBMC/config.cpp

${OBJECTDIR}/_ext/21457980/interpret.o: /root/NetBeansProjects/gSpeakXBMC/interpret.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/21457980
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/21457980/interpret.o /root/NetBeansProjects/gSpeakXBMC/interpret.cpp

${OBJECTDIR}/_ext/21457980/listen.o: /root/NetBeansProjects/gSpeakXBMC/listen.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/21457980
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/21457980/listen.o /root/NetBeansProjects/gSpeakXBMC/listen.cpp

${OBJECTDIR}/_ext/21457980/speak.o: /root/NetBeansProjects/gSpeakXBMC/speak.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/21457980
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/21457980/speak.o /root/NetBeansProjects/gSpeakXBMC/speak.cpp
